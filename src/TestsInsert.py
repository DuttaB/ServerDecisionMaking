...
class TestServerMethods(unittest.TestCase):
    ...
    def test_lambda(self):
        lambda_events = [
            ...
            generate_lambda("ok", "sensors", "INSERT"),  # no change(old status defaults to fire
            generate_lambda("ok", "users", "INSERT"), #user message
            generate_lambda("ok", "robots", "INSERT"), #insert robot
        ]

        lambda_responses = [
            '{"message": {"body": {"type": "motion detector", "model": "KM07", "new_id": "9", "buildingId": "5"}, "msg_type": "new sensor"}, "id": ["5"]}',
            '{"message": {"body": {"xpos": "5", "room": "3", "floor": "2", "new_id": "8", "ypos": "4", "owner": false, "buildingId": "7"}, "msg_type": "new user"}, "id": ["7"]}',
            '{"message": {"body": {"ypos": "4", "xpos": "7", "room": "3", "floor": "1", "sensorId": ["0", "56"], "new_id": "9", "buildingId": "5", "capabilities": ["attack", "vent"], "movement": "air"}, "msg_type": "new robot"}, "id": ["5"]}'
        ]
